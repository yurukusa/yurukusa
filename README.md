...
🔥 **New: [Token Book — Cut Your Claude Code Token Usage in Half](https://yurukusa.github.io/cc-safe-setup/token-book.html)** (¥2,500 / ~$17) — 10 chapters, copy-paste templates, 800h of real data. [Free diagnostic →](https://yurukusa.github.io/cc-safe-setup/token-checkup.html)
| Project | What it does |
|---------|-------------|
| [**cc-safe-setup**](https://github.com/yurukusa/cc-safe-setup) | One command to make Claude Code safe. 664 hooks. `npx cc-safe-setup` |
...
- [Qiita](https://qiita.com/yurukusa) — 53,000+ views. Claude Code tutorials
